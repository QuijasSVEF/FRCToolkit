...
export const sections: Section[] = [
  ...
  },
  {
    id: 'design-cad',
    title: 'Design & CAD',
    description: 'Robot design process, Onshape CAD, prototyping, and mechanism design patterns',
    icon: 'Compass',
    estimatedMinutes: 40,
    subsections: [
      { id: 'design-process', title: 'The FRC Design Process' },
      { id: 'onshape-basics', title: 'Onshape Fundamentals' },
      { id: 'frc-cad-organization', title: 'FRC CAD Organization' },
      { id: 'mechanism-design', title: 'Mechanism Design Patterns' },
      { id: 'prototyping', title: 'Prototyping' },
      { id: 'engineering-drawings', title: 'Engineering Drawings' },
      { id: 'design-resources', title: 'Design Resources & References' },
    ],
  },
  {
    id: 'mechanical',
    title: 'Mechanical Systems',
    description: 'Drivetrain, mechanisms, fabrication, materials, and maintenance',
    icon: 'Wrench',
    estimatedMinutes: 35,
    subsections: [
      ...
      { id: 'kitbot', title: 'KitBot & Everybot' },
      ...
      { id: 'maintenance', title: 'Maintenance & Pit Operations' },
    ],
  },
  {
    id: 'electrical',
  ...
  },
  {
    id: 'programming',
    title: 'Programming',
    description: 'Software architecture, WPILib, motors & sensors, autonomous, vision, and debugging',
    icon: 'Code',
    estimatedMinutes: 50,
    subsections: [
      ...
      { id: 'motors-sensors', title: 'Motors & Sensors' },
      ...
      { id: 'debugging', title: 'Debugging & Best Practices' },
      { id: 'programming-calendar', title: 'Programming Season Calendar' },
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Curated library of official docs, community tools, training curriculums, and videos',
    icon: 'Library',
    estimatedMinutes: 15,
    subsections: [
      ...
      { id: 'training-curriculums', title: 'Training Curriculums & Courses' },
